                ...
                <form action="" method="post">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <a class="thumbnail" href=""><img src="images/<?php echo $photo->filename; ?>" class="img-responsive" width="300px" alt=""></a>
                    ...
                    <div class="col-md-4">
                        <div class="photo-info-box">
                            ...
                            <div class="inside">
                                <div class="box-inner">
                                    <p class="text">
                                        <span class="glypicon glypicon-calendar"></span>Uploaded on
                                    </p>
                                    ...
                                    <p class="text">
                                        File Size: <span class="data">324566</span>
                                    </p>
